...
function addToCart(button) {
    ...
    var imgSrc = product.querySelector('.large-img').src;
    var nameElement = product.querySelector('.name_table');
    var priceElement = product.querySelector('.price_1');
    var quantity = product.querySelector('.product-quantity').value;


    var name = nameElement.innerText.replace('نام محصول: ', '').trim();
    var price = priceElement.innerText.replace('قیمت: ', '').trim();
